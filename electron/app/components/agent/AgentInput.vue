    ...
    <div v-if="instance" class="relative group w-full">
        ...
        <div v-if="instance.messageQueue.length > 0"
            ...
            <div
                ...
                <div class="w-1.5 h-1.5 rounded-full bg-gray-900 animate-pulse" :style="{ backgroundColor: instance.color }"></div>
        ...
        <div class="flex items-end gap-2">
            <div class="input-box flex-1 flex items-end gap-2 transition-all focus-within:border-gray-400"
                ...
                <button v-if="instance.isProcessing" 
                    @click="store.stopProcessing(instanceId)"
                    class="p-1 text-red-500 hover:scale-110 transition-transform mb-1"
                    title="Stop">
                    <Square class="w-4 h-4 fill-current" />
                </button>
                <button v-else-if="prompt.trim()" 
                    @click="handleSend"
                    class="p-1 hover:scale-110 transition-transform mb-1"
