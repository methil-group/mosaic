                ...
                <div
                    ...
                    <div class="flex-1 overflow-hidden">
                        <div class="grid grid-cols-2 h-full">
                            ...
                            <div class="p-6 space-y-6 overflow-y-auto border-r border-white/5 custom-scrollbar-mini">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div
                                        ...
                                        <button v-for="model in store.availableModels" :key="model.id"
                                            ...
                                            <span class="text-[9px] font-mono opacity-40 uppercase tracking-widest">{{
                                                model.id }}</span>
                                        </button>
                                    </div>
                                </div>
