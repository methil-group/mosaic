...
import { Send, Bot, User, Terminal, Loader2, Sparkles, Folder, Cpu, ChevronDown, Trash2, Copy, Check, Settings, X } from 'lucide-vue-next'
            ...
            <div class="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div class="flex flex-col min-w-0 flex-1">
                    <div class="flex items-center gap-2">
                        <h1 class="text-[11px] font-black tracking-widest text-white uppercase truncate">{{ instance.name }}</h1>
        ...
        <Teleport to="body">
            <Transition enter-active-class="transition duration-300 ease-out" 
                ...
                <div v-if="isSettingsOpen" class="fixed inset-0 z-[1000] flex items-center justify-center p-4">
                    ...
                    <!-- Modal Content -->
                    <div class="relative w-full max-w-lg bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-3xl overflow-hidden animate-in zoom-in-95 duration-300">
                        <div class="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/[0.02]">
                            <div class="flex items-center gap-3">
                                ...
                                <h2 class="text-xs font-black uppercase tracking-widest text-white">Agent Configuration</h2>
                            </div>
                            <button @click="isSettingsOpen = false" class="p-2 hover:bg-white/5 rounded-lg transition-colors text-white/40 hover:text-white">
                                <X class="w-4 h-4" />
                            </button>
                        </div>
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <!-- Model Selection -->
                            <div class="space-y-2">
                                <label class="text-[9px] font-black uppercase tracking-widest text-white/30 ml-1">Logic Model</label>
                                <div class="grid grid-cols-1 gap-1.5 max-h-48 overflow-y-auto pr-2 custom-scrollbar-mini">
                                    <button v-for="model in store.availableModels" :key="model.id"
                                        ...
                                        <span class="text-[9px] font-mono opacity-40 uppercase tracking-widest">{{ model.id }}</span>
                                    </button>
                                </div>
                            </div>
                        </div>

                        <div class="p-4 bg-white/[0.02] border-t border-white/5 flex justify-end px-6">
